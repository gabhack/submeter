...
(function () {
  ...
  function cb(m) {
    if (!Ya) {
      ...
      "undefined" === typeof sa.Chart.creditHref
        ? ((m.creditHref = ka("iuuqr;..b`ow`rkr/bnl.")),
          (m.creditText = ka("B`ow`rKR/bnl")))
  ...
  function X(m, s, q, v, x) {
    ...
    m = {};
    this.theme && y(s) && y(v)
      ? (m = y(ya[this.theme]) ? ya.light1 : ya[this.theme])
      : this.parent &&
        ...
        return (P = C.replace(m, function (c) {
          switch (c) {
            ...
            case "K":
              return U
                ? "UTC"
                : (String(Q).match(x) || [""]).pop().replace(z, "");
            case "z":
  ...
  X.prototype.updateOption = function (m) {
    var s = sa[this._defaultsKey],
      ...
      z = this._index;
    this.theme && y(x) && y(z)
      ? (q = y(ya[this.theme]) ? ya.light1 : ya[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[x] &&
        (null === z
          ? (q = this.parent.themeOptions[x])
          : 0 < this.parent.themeOptions[x].length &&
            ((q = Math.min(this.parent.themeOptions[x].length - 1, z)),
            (q = this.parent.themeOptions[x][q])));
    this.themeOptions = q;
    m in s &&
      (v = m in this.options ? this.options[m] : q && m in q ? q[m] : s[m]);
  ...
  Ea.prototype.registerSpace = function (m, s) {
    "top" === m
      ? (this._topOccupied += s.height)
      : "bottom" === m
      ? (this._bottomOccupied += s.height)
      : "left" === m
      ? (this._leftOccupied += s.width)
      : "right" === m && (this._rightOccupied += s.width);
  };
  ...
  la.prototype._getLineWithWidth = function (m, s, v) {
    ...
    v > s &&
      1 < G.length &&
      ((G = G.substr(0, G.length - 1)), (v = this.ctx.measureText(G).width));
    s = !0;
  ...
  Ia.prototype.render = function () {
    if (this.text) {
      ...
      y(this.padding) || "number" !== typeof this.padding
        ...
        : (P = 2.5 * this.padding);
      this.wrap ||
        (G = Math.min(G, Math.max(1.5 * this.fontSize, this.fontSize + P)));
      G = new la(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((x = v.y2 - 2 - P.height), (C = "bottom")),
          "left" === this.horizontalAlign
            ? (q = v.x1 + 2)
            : "center" === this.horizontalAlign
            ? (q = v.x1 + v.width / 2 - P.width / 2)
            : "right" === this.horizontalAlign && (q = v.x2 - 2 - P.width - R),
  ...
  x.Chart = (function () {
    ...
    function C(a, f, b, c, e, g) {
      ...
      this.options.crosshair &&
        (this.crosshair = new ia(this.chart, this.options.crosshair, this));
            ...
            f
              ...
              : (qa(a, a._zoomButton, {
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  qa(a, a._zoomButton.childNodes[0], {
        ...
        this._resetButton ||
          ...
          N(this._resetButton, "mouseover", function () {
            f ||
              ...
              0 >= navigator.userAgent.search("MSIE") &&
                qa(a, a._resetButton.childNodes[0], {
                  WebkitFilter: "invert(100%)",
                  filter: "invert(100%)",
                }));
          }),
          ...
          N(
            ...
            function () {
              f ||
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  qa(a, a._menuButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)",
                  }));
            },
      ...
      this.options.height
        ...
        : (this.height = f =
            0 < this.container.clientHeight
              ? this.container.clientHeight
              : this.height);
      return this.canvas.width !== a * ha || this.canvas.height !== f * ha
        ? (Ha(this.canvas, a, f),
    ...
    q.prototype.render = function (a) {
      ...
      this._processData();
      this.options.title &&
        ((this.title = new Ia(this, this.options.title)),
      ...
      for (a = 0; a < this.plotInfo.plotTypes.length; a++)
        for (
          ...
          "line" === t.type
            ...
            : "boxAndWhisker" === t.type && (k = this.renderBoxAndWhisker(t));
      ...
      this.animatedRender &&
        ...
        ((g = ua(this.width, this.height).getContext("2d")),
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var D = this.sessionVariables.axisX.newViewportMinimum
          ...
          for (n = 0; n < p.dataPoints.length; n++) {
            ...
            if (c < D && !d) null !== p.dataPoints[n].y && (za = c);
              ...
              null === p.dataPoints[n].y
                ? b.viewPortMin === c && za < c && (b.viewPortMin = za)
        ...
        for (
          ...
          if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement)
            var m = this.sessionVariables.axisX.newViewportMinimum
                ...
                ? this.options.axisX.minimum
                : -Infinity,
              D = this.sessionVariables.axisX.newViewportMaximum
                ? this.sessionVariables.axisX.newViewportMaximum
                : this.options.axisX && this.options.axisX.viewportMaximum
                ? this.options.axisX.viewportMaximum
                : this.options.axisX && this.options.axisX.maximum
    ...
    q.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var ca = k.dataPoint.indexLabelFormatter
          ...
          ? k.dataSeries.indexLabelFormatter(S)
        ...
        if (null !== ca && "" !== ca) {
          ...
          if ("stackedarea100" === r) {
            ...
            if (
              k.dataPoint.x < q.viewportMinimum ||
          ...
          D &&
            ...
            0 <= r.indexOf("bar") || ("error" === r && k.axisSwapped)
              ...
              : f.lineTo(
                  p + l / 2,
                  n +
                    ((n < k.point.y ? t : -t) + ("horizontal" === S ? t : -t)) /
                      2
                ),
            f.stroke());
        }
        ...
        for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var s = !1, u = 0; u < r.length; u++)
              if (
                ((S = r[u].x.getTime ? r[u].x.getTime() : r[u].x),
                !(
                ...
                if ("number" !== typeof r[u].y)
                  ...
                  D || s
                    ...
                    : (b.lineTo(S, ca),
                      ...
                      0 == u % 500 &&
                        ...
                        b.beginPath(),
                        b.moveTo(S, ca),
                        v && (c.stroke(), c.beginPath(), c.moveTo(S, ca))));
                  h = {
                    x: S,
                    y: ca,
                  };
                  u < r.length - 1 &&
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ? ((p = r[u].lineDashType),
                          b.setLineDash(G(p, k.lineThickness)))
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var s = !1, u = 0; u < r.length; u++)
              if (
                ((S = r[u].getTime ? r[u].x.getTime() : r[u].x),
                !(
                  S < a.axisX.dataInfo.viewPortMin ||
                  (S > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !s))
                ...
                if ("number" !== typeof r[D].y)
                  0 < D &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !r[D - 1].lineDashType) &&
                        ((q[q.length - 1].newLineDashArray = n),
                        (p = k.nullDataLineDashType))
                      : (f(q), (q = []))),
                    (S = !0);
                else {
                  ...
                  D < r.length - 1 &&
                    ...
                    c.setLineDash &&
                      (r[D].lineDashType
                        ? ((p = r[D].lineDashType),
                          (q[q.length - 1].newLineDashArray = G(
                            p,
                            k.lineThickness
                          )))
                        : ((p = k.lineDashType),
              ...
              if (
                ...
                !(
                  ...
                  (q > a.axisX.dataInfo.viewPortMax &&
                    (!w.connectNullData || !ea))
                ))
              )
                if ("number" !== typeof m[D].y)
                  w.connectNullData || ea || f || c(), (ea = !0);
                else {
                  ...
                  D < m.length - 1 &&
                    ...
                    g.setLineDash &&
                      (m[D].lineDashType
                        ? ((b = m[D].lineDashType),
                          g.setLineDash(G(b, w.lineThickness)))
              ...
              if (
                ...
                "number" !== typeof m[D].y
                  ...
                  : ((u = a.axisX.convertValueToPixel(q)),
                    ...
                    D < m.length - 1 &&
                      (J !== (m[D].lineColor || z) ||
                        I !== (m[D].lineDashType || w.lineDashType)) &&
                      (c(),
                      (J = m[D].lineColor || z),
                      (g.strokeStyle = J),
                      g.setLineDash &&
                        (m[D].lineDashType
                          ? ((I = m[D].lineDashType),
                            g.setLineDash(G(I, w.lineThickness)))
                          : ((I = w.lineDashType), g.setLineDash(ea)))),
                    (q = w.dataPointIds[D]),
                    (this._eventManager.objectMap[q] = {
                      id: q,
                      objectType: "dataPoint",
            ...
            for (var ea = !0, p = 0; p < k.length; p++) {
              ...
              if (
                !(
                  w < a.axisX.dataInfo.viewPortMin ||
                  (w > a.axisX.dataInfo.viewPortMax &&
                    (!A.connectNullData || !ea))
                )
              )
                if ("number" !== typeof $.y)
                  A.connectNullData || ea || q || f(), (ea = !0);
                else {
                  ...
                  p < z.length - 1 &&
                    (J !== (z[p].lineColor || L) ||
                      y !== (z[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(n, d),
                    t.push({
                    ...
                    c.setLineDash &&
                      (z[p].lineDashType
                        ? ((y = z[p].lineDashType),
                          c.setLineDash(G(y, A.lineThickness)))
                        : ((y = A.lineDashType), c.setLineDash(da))));
          ...
          if (0 < k.length) {
            ...
            for (var ea = !0, p = 0; p < k.length; p++) {
              ...
              if (
                ...
                if ("number" !== typeof $.y)
                  A.connectNullData || ea || s || f(), (ea = !0);
                else {
                  var xa;
                  xa =
                    0 !== a.dataPointYSums[w]
                      ? 100 * ($.y / a.dataPointYSums[w])
                      : 0;
                  n = a.axisX.convertValueToPixel(w);
                  var oa = l[w] ? l[w] : 0;
                  if (
                  ...
                  p < z.length - 1 &&
                    ...
                    c.setLineDash &&
                      (z[p].lineDashType
                        ? ((u = z[p].lineDashType),
                          c.setLineDash(G(u, A.lineThickness)))
    ...
    q.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length)
            for (
              var ca = 5 < w && u.bevelEnabled ? !0 : !1, l = 0;
              l < q.length;
              l++
            )
              if (
    ...
    q.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < x.length)
            for (
              var z = 5 < w && q.bevelEnabled ? !0 : !1, h = 0;
              h < x.length;
              h++
            )
              if (
                ...
                var B = (l - w / 2) << 0,
                  ...
                  I =
                    "number" === typeof x[h].whiskerThickness
                      ...
                      ? q.whiskerThickness
                      : C,
                  da = x[h].whiskerDashType
                    ? x[h].whiskerDashType
                    : q.whiskerDashType,
                  ea = y(x[h].whiskerLength)
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          var x = a.dataSeriesIndexes[s],
            ba = this.data[x],
            B = ba.dataPoints,
            A = y(ba._linkedSeries)
              ? !1
              : ba._linkedSeries.type.match(/(bar|column)/gi) &&
                ba._linkedSeries.visible
              ? !0
              : !1,
            C = 0;
          if (A)
            for (e = ba._linkedSeries.id, u = 0; u < e; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                !this.data[u].visible ||
          ...
          if (0 < B.length)
            for (var L = ba._colorSet, l = 0; l < B.length; l++) {
              var e = (ba.lineColor = ba.options.color
                  ? ba.options.color
                  : L[0]),
                J = {
                  ...
                  length: y(B[l].whiskerLength)
                    ? y(ba.options.whiskerLength)
                      ? u
                      : ba.options.whiskerLength
                    : B[l].whiskerLength,
                ...
                if (
                  ...
                  d < p.length - 1 &&
                    ...
                    c.setLineDash &&
                      (p[d].lineDashType
                        ? ((A = p[d].lineDashType),
                          (t[t.length - 1].newLineDashArray = G(
                            A,
                            r.lineThickness
                          )),
                ...
                if (
                  ...
                  p < r.length - 1 &&
                    ...
                    c.setLineDash &&
                      (r[p].lineDashType
                        ? ((z = r[p].lineDashType),
                          (m[m.length - 1].newLineDashArray = G(
                            z,
                            k.lineThickness
                          )))
                        : ((z = k.lineDashType),
            ...
            for (
              ...
              if (
                ...
                0 < h &&
                  B &&
                  (!x || m.connectNullData) &&
                  (x && b.setLineDash && b.setLineDash(G(z, u)),
                  b.beginPath(),
                  b.moveTo(B, A - s),
                  b.lineTo(J, I - s),
                  0 < u && b.stroke(),
          ...
          (c = d[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(
                    G(c.indexLabelLineDashType, c.indexLabelLineThickness)
                  ),
                a.beginPath(),
                a.moveTo(e, f),
              ...
              if (null !== B) {
                ...
                if (0 > z) {
                  for (var ba = (y = 0), G = 0; G < r.length; G++)
                    G !== a &&
                      d[G].hemisphere === l.hemisphere &&
                      (d[G].indexLabelTextBlock.y < l.indexLabelTextBlock.y
                        ? y++
                        : ba++);
                  y = (z / (y + ba || 1)) * ba;
                  var ba = -1 * (z - y),
                  ...
                  "right" === l.hemisphere
                    ? ((G = g(a, y)),
                      (ba = -1 * (z - G)),
                      (H = g(B, ba)),
                      +H.toFixed(v) < +ba.toFixed(v) &&
                        +G.toFixed(v) <= +y.toFixed(v) &&
                        g(a, -(ba - H)))
                    : ((G = g(B, y)),
                      (ba = -1 * (z - G)),
                      (H = g(a, ba)),
            ...
            if (
              ...
              (B = B = 0),
                ...
                0 < B &&
                  ...
                  ((B /= Math.abs(Math.cos(l.indexLabelAngle))),
                  9 < B && (B *= 0.3),
                  B > f && (f = B)),
                (B = B = 0),
                ...
                0 < B &&
                  ...
                  Math.abs(l.indexLabelTextBlock.x - x.x) < A &&
                    ((B /= Math.abs(Math.sin(l.indexLabelAngle))),
                    9 < B && (B *= 0.3),
                    B > f && (f = B)));
    ...
    q.prototype.renderFunnel = function (a) {
        ...
        if (e)
          for (h = F.length - 1; 0 <= h; h--)
            (a = M[h]),
              ...
              (F[h].textBlock.x = P - g),
              (c =
                F[h].textBlock.height < F[h].textBlock.maxHeight
                  ? F[h].textBlock.height
                  : F[h].textBlock.maxHeight),
              (e =
                F[h].textBlock.width < F[h].textBlock.maxWidth
                  ? F[h].textBlock.width
                  : F[h].textBlock.maxWidth),
              (F[h].height = c),
              (F[h].width = e),
              (c =
              ...
              u.reversed
                ? (F[h].textBlock.y + F[h].height > T + C &&
                    (F[h].textBlock.y = T + C - F[h].height),
                  F[h].textBlock.y < ta - C && (F[h].textBlock.y = ta - C))
                : (F[h].textBlock.y < T - C && (F[h].textBlock.y = T - C),
                  F[h].textBlock.y + F[h].height > ta + C &&
                    (F[h].textBlock.y = ta + C - F[h].height));
      }
          ...
          for (var f = 0; f < M.length; f++)
            0 == F[f].textBlock.text.length
              ...
              : ((a = M[f]),
                ...
                u.reversed
                  ? (F[f].textBlock.y + F[f].height > T + C &&
                      (F[f].textBlock.y = T + C - F[f].height),
                    F[f].textBlock.y < ta - C && (F[f].textBlock.y = ta - C))
                  : (F[f].textBlock.y < T - C && (F[f].textBlock.y = T - C),
                    F[f].textBlock.y + F[f].height > ta + C &&
                      (F[f].textBlock.y = ta + C - F[f].height)));
        else
      ...
      function h() {
        ...
        function b() {
          ...
          for (var k, l = 1; l < h; l++) {
            ...
            for (var r = F.length - 1; 0 <= r; r--)
              !F[r].isDirty &&
                F[r].textBlock.y < e &&
                F[r].textBlock.y + F[r].height > e &&
                ((k = n(r)),
                !(k >= F.length - 1) &&
                  F[r].textBlock.y + F[r].height + ha > F[k].textBlock.y &&
                  (F[r].textBlock.y =
                    F[r].textBlock.y + F[r].height - e > e - F[r].textBlock.y
                      ? e + 1
                      : e - F[r].height - 1));
          }
          for (k = M.length - 1; 0 < k; k--)
            if (!F[k].isDirty) {
              ...
              if (F[k].textBlock.y < F[e].textBlock.y + F[e].height) {
                ...
                for (
                  h = 0;
                  F[f].textBlock.y < F[e].textBlock.y + F[e].height + ha;
        ...
        for (var d, e, f, g, h, k, t = 1, r = 0; r < 2 * t; r++) {
          for (
            var m = F.length - 1;
            0 <= m &&
            !((previousTextBlock = (previousLabel = 0 <= p(m) ? F[p(m)] : null)
      ...
      function l(a, b) {
        return (
          (b < M.length ? F[b].textBlock.y : u.reversed ? T + C : ta + C) -
          (0 > a
            ? u.reversed
              ? ta - C
              : T - C
            : F[a].textBlock.y + F[a].height + ha)
        );
      }
      ...
      function t(a, b, c) {
        ...
        if (0 === ma.length) h = ka;
          ...
          e =
            (C *
              (1 != ma.length || (0 != ma[0] && ma[0] != M.length - 1)
                ? 2
                : 1)) /
            k();
      ...
      function r(a) {
        for (var b, c, e, f, g = 0; g < M.length; g++)
          (f = 1 === F[g].lineThickness % 2 ? 0.5 : 0),
            ...
            F[g].isDirty ||
              0 == F[g].lineThickness ||
              ((a.strokeStyle = F[g].lineColor),
              (a.lineWidth = F[g].lineThickness),
              a.setLineDash &&
                a.setLineDash(G(F[g].lineDashType, F[g].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(e, f),
              a.stroke());
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            A = 0,
            O = z.height - 2 * C,
            L = Math.min(z.width - 2 * B, 2.8 * z.height),
            J = !1,
            I = 0;
          I < x.length;
          I++
          ...
          if (
            (!J &&
              "undefined" !== typeof x[I].indexLabel &&
              null !== x[I].indexLabel &&
              0 < x[I].indexLabel.toString().length &&
              (J = !0),
            !J &&
              "undefined" !== typeof x[I].label &&
              null !== x[I].label &&
              0 < x[I].label.toString().length &&
              (J = !0),
            (!J && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof x[I].indexLabelFormatter)
          )
            J = !0;
        J =
          J ||
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          var U = (30 * (P - a)) / 100;
          "funnel" === u.type
            ? ((N = y(u.options.neckHeight) ? 0.35 * O : u.neckHeight),
              ...
              E > a ? (E = a - 0.5) : 0 >= E && (E = 0))
            : "pyramid" === u.type &&
              ((E = N = 0), (u.reversed = u.reversed ? !1 : !0));
          var B = I + a / 2,
            X = I,
            V = I + a,
            T = u.reversed ? $ : Q,
          ...
          if (-1 !== I) {
            if (u.reversed)
              for (L.push(W), E = I.length - 1; 0 < E; E--)
                (W += I[E]), L.push(W);
            else for (E = 0; E < I.length; E++) (W += I[E]), L.push(W);
            if (u.reversed)
              for (E = 0; E < I.length; E++)
                L[E] < aa
                  ? (a.push(K), B.push(Y), (ga = E))
                  : (a.push((L[E] - T + fa * X) / fa),
            ...
            for (E = 0; E < x.length; E++)
              x[E].exploded &&
                ((I = !0), u.reversed ? ma.push(x.length - 1 - E) : ma.push(E));
            ...
            if (((b = this.logLabelValues[c]), b < this.viewportMinimum)) c++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[m]
                  : W(m, this.valueFormatString, this.chart._cultureInfo)),
                (a = new la(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: g,
    ...
    C.setLayoutAndRender = function (a, f, b, c, e, g) {
      ...
      for (
        ...
        n[d] &&
          n[d].title &&
          (n[d]._titleTextBlock = new la(n[d].ctx, {
            text: n[d].title,
            horizontalAlign: "center",
      ...
      if ("normal" === e) {
        for (
          ...
          t = Math.round(
            g.x2 - aa - Z > m.width - 10 ? m.width - 10 : g.x2 - aa - Z
          );
          if (a && 0 < a.length)
            for (z = [], d = Y = 0; d < a.length; d++)
                ...
                a[d] &&
                  ...
                  0 < l
                    ...
                    : a[d].viewportMaximum === a[d].maximum &&
                      ...
                      (0 < L && (h += L), 0 < l && (t -= l))),
                m.panEnabled
                  ? (Y = m.sessionVariables.axisX.height)
                  : (m.sessionVariables.axisX.height = Y),
                ...
                f[d]._labels &&
                  ...
                  (u =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                m.panEnabled
                  ? (W = m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = W),
                (l = Math.round(g.y1)),
          ...
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
              (b[d].lineCoordinates = {}),
                ...
                (t = Math.round(
                  g.x2 - W - V > m.width - 10 ? m.width - 10 : g.x2 - W - V
                )),
                b[d].labelAutoFit &&
                  !y(z) &&
                  (0 < !a.length &&
            ...
            for (d = 0; d < a.length; d++) {
                ...
                b && 0 < b.length
                  ? Math.round(
                      b[0]
                        ...
                        : g.y2 - X > m.height - Math.max(K, 10)
                        ? m.height - Math.max(K, 10)
                        : g.y2 - X
                    )
                  : g.y2 > m.height - Math.max(K, 10)
                  ? m.height - Math.max(K, 10)
                  : g.y2;
              if (b && 0 < b.length)
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((t = c[K].lineCoordinates.x1), (h = t - Y));
              a[d].lineCoordinates = {
                x1: t - Q,
                y1: l,
                x2: t - Q,
            ...
            for (d = 0; d < f.length; d++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((t = c[K].lineCoordinates.x2), (h = t - W));
              f[d].lineCoordinates = {
                x1: t + U,
                y1: l,
                x2: t + U,
        ...
        if (b && 0 < b.length)
          for (d = 0; d < b.length; d++)
            b[d].calculateBreaksInPixels(), b[d].renderLabelsTicksAndTitle();
        if (c && 0 < c.length)
          for (d = 0; d < c.length; d++)
    ...
    C.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = c || !y(f[g].options.spacing)),
          (f[g].spacing =
            O(f[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
    ...
    C.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          f.setLineDash &&
            f.setLineDash(G(this.lineDashType, this.lineThickness));
          var h =
        ...
        if ("axisX" === this.type && b) {
          this.intervalType ||
            (c / 1 <= a
              ...
              : c / (6 * U.monthDuration) <= a
              ? ((this.interval = 6), (this.intervalType = "month"))
              : ((this.interval =
                  c / (1 * U.yearDuration) <= a
                    ? 1
                    : c / (2 * U.yearDuration) <= a
                    ? 2
                    : c / (4 * U.yearDuration) <= a
                    ? 4
                    : Math.floor(
                        C.getNiceNumber(c / (a - 1), !0) / U.yearDuration
                      )),
          ...
          if (
            ...
            if (
              ...
              l.text = this.labelFormatter
                ...
                : y(this.options.label)
                ? W(u, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (h =
                1 === r.lineWidth % 2
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  var h = this.chart.axisX[m].convertPixelToValue({
                      y: f,
                    }),
                    k = null,
                    c = 0;
            ...
            if (this.chart.axisX)
              for (m = 0; m < this.chart.axisX.length; m++)
                for (
                  h = this.chart.axisX[m].convertPixelToValue({
                    x: a,
                  }),
                    k = null,
                    c = 0;
