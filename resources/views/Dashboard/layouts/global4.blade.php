    ...
    <div class="wrapper">
        <div class="sidebar">
            <nav class="navbar navbar-expand-lg navbar-side navbar-dark sticky-top flex-md-nowrap p-0">
                ...
                <button class="navbar-toggler mr-3 d-inline d-md-none" type="button" data-toggle="collapse"
                    data-target="#side-menu" aria-controls="menuVertical" aria-expanded="true">
                    <span class="navbar-toggler-icon"></span>
                </button>
            </nav>
            <div class="d-none d-md-inline">
                <div class="cnt-nav-submeter bg-submeter-1 scrollbar-submeter nav-menu">
                    @include('Dashboard.includes.menu4', ['user_log' => $user])
                </div>
            </div>
