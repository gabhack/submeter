      ...
      {({
        ...
        useEffect(() => {
          ...
          setValues({
            ...
            decimals: data.decimals
              ? data.decimals
              : data.number_type && data.number_type == 2
              ? "0"
              : "",
        ...
        return (
          ...
          >
              ...
              <Form noValidate onSubmit={handleSubmit}>
                <Form.Row>
                  ...
                  <InputText
                    ...
                    placeholder="Entre el nombre a mostrar"
                    onChange={handleChange}
                  />
                </Form.Row>
                <Form.Row>
                  <Select
                    ...
                    onChange={handleChange}
                  >
                    {props.productionTypes &&
                      props.productionTypes.map((t) => (
                  ...
                  <InputMultiselect
                    ...
                    label="Mostrar en"
                    placeholder="Seleccione donde mostrar"
                ...
                <Form.Row>
                  <Select
                    ...
                    placeholder="Seleccione el tipo de operacion"
                    onChange={handleChange}
                  >
                    <option value="1" data-min="1" data-max="1">
                      SUMATOTAL
                    </option>
                    <option value="2" data-min="1" data-max="1">
                      PROMEDIO
                    </option>
                    <option value="3" data-min="1" data-max="1">
                      MEDIANA
                    </option>
                    <option value="4" data-min="1" data-max="1">
                      {" "}
                      MIN
                    </option>
                    <option value="5" data-min="1" data-max="1">
                      MAX
                    </option>
                    <option value="6" data-min="1" data-max="1">
                      {" "}
                      DESVIACIÓN ESTANDAR
                    </option>
                  </Select>
                  <Select
                    ...
                    type="text"
                    name="number_type"
                    value={values.number_type}
                    label="Tipo de numero"
                    placeholder="Seleccione el tipo de numero"
                    onChange={(e) => {
                ...
                <Form.Row>
                  <InputText
                    ...
                    label="Unidades"
                    placeholder="Entre el valor de unidades"
                    onChange={handleChange}
                  />
                  <InputText
                    className="col-4"
                    type="number"
                    name="decimals"
                    readOnly={values.number_type != 1}
                    value={values.decimals}
                    label="Decimales"
                    placeholder="Entre los decimales a usar"
                    onChange={handleChange}
                  />
                  {currentChart === "combinada" && (
                    <Select
                      className="col-4"
                ...
                <Form.Row>
                  <div className="col-6">
                    <InputArea
                      ...
                      label="Expresión"
                      placeholder="Expresion a evaluar"
                      onChange={handleChange}
                    />
                  </div>
                  <div className="col-6">
                    ...
                    <div>
                      ...
                      >
                        <tbody>
                          {values.database_fields.length > 0 &&
                            values.database_fields.map((field, index) => (
                              <tr key={index}>
                                <td
                                  style={{
                                    padding: "0",
                                ...
                                <td
                                  style={{ padding: "1px 5px", width: "50px" }}
                                >
                                  <Dropdown size="sm">
                                    <Dropdown.Toggle
                                      variant="light"
            ...
            <StatisticConfigFieldData
              type={props.type}
              onHide={onCloseFieldData}
              show={currentFieldData.show}
              data={currentFieldData.data}
              metadata={props.databaseMeta}
            />
          </Modal>
        );
      }}
