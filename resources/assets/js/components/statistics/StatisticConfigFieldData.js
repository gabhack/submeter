  ...
  return (
    <div>
      <Formik
        ...
        onSubmit={(values) => {
          const connName = props.metadata.find(
            (f) => f.id == values.connection
          ).name;
              ...
              <Modal.Body>
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  <Select
                    ...
                    label="Conección"
                    placeholder="Seleccione la connección base de datos"
                    onChange={(e) => {
                      handleChange(e);
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      handleChange(e);
                      loadFields(values.connection, e.target.value);
                    }}
                  >
                    {tables.length > 0 &&
                      tables.map((f) => (
                  ...
                  {props.type !== "representacion" && (
                    <Select
                      ...
                      label="Agrupar por intervalos en"
                      placeholder="Seleccione método de agrupamiento"
                      onChange={handleChange}
                    >
